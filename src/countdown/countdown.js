...
IOWA.CountdownTimer.Intro.prototype.update = function () {
  ...
  if (this.count > this.radius - this.parent.strokeWeight - .05) this.firstRun && (this.parent.bands[e].aShift *= -1, this.parent.bands[e].colors[0].hex = "#FA576C", this.parent.bands[e].oldShape = 0, this.parent.bands[e].currentShape = 0, this.parent.bands[e].isPlaying = !0, this.parent.bands[e].fade("in"), this.firstRun = !1, setTimeout(this.outro.bind(this), IOWA.CountdownTimer.INTRO_LENGTH)), this.parent.bands[e].update();
  else {
    t.save(), t.scale(this.parent.pixelRatio, this.parent.pixelRatio), t.beginPath(), t.arc(this.circle.x + this.center.x, this.circle.y + this.center.y, this.radius, 0, 2 * Math.PI, !1), t.fillStyle = "#FA576C", t.fill();
    var i = this.count;
  ...
  for (var n = 0; n < this.rectangles.length; n++) {
    ...
    t.lineTo(this.rectangles[n][0].x * this.radius + this.center.x, this.rectangles[n][0].y * this.radius + this.center.y), t.fillStyle = "#FA576C", t.fill()
  }
  return t.restore(), !1
};
...
IOWA.CountdownTimer.Core = function (t, e) {
  this.targetDate = t;
  this.element = e;
  this.containerDomElement = this.element.timerElement;
...
IOWA.CountdownTimer.Core.prototype.checkTime = function () {
  ...
  if (this.firstRun) {
    var e = t.days + " days, " + t.hours + " hours, " + t.minutes + " minutes, " + t.seconds + " seconds until ITCO Workshop 2018!";
...
IOWA.CountdownTimer.Core.prototype.addUnits = function () {
  ...
  e.save(), e.scale(this.pixelRatio, this.pixelRatio), e.font = "500 12px Roboto", e.fillStyle = "#FA576C", e.textAlign = "center", e.fillText("Days", this.bands[0].center.x + this.layout.radius + this.bandPadding / 2, this.bands[0].center.y + this.layout.radius + t), e.fillText("Hours", this.bands[2].center.x + this.layout.radius + this.bandPadding / 2, this.bands[2].center.y + this.layout.radius + t), e.fillText("Minutes", this.bands[4].center.x + this.layout.radius + this.bandPadding / 2, this.bands[4].center.y + this.layout.radius + t), e.fillText("Seconds", this.bands[6].center.x + this.layout.radius + this.bandPadding / 2, this.bands[6].center.y + this.layout.radius + t), e.restore()
};
IOWA.CountdownTimer.Core.prototype.addSeparators = function () {
  var t = this.canvasElement.getContext("2d");
  t.save(), t.scale(this.pixelRatio, this.pixelRatio);
  for (var e = 0; e < this.separators.length; e++) t.clearRect(this.separators[e].x - 2, this.separators[e].y - 2, this.separators[e].w + 4, this.separators[e].h + 4), t.beginPath(), t.moveTo(this.separators[e].x, this.separators[e].y), t.lineTo(this.separators[e].x + this.separators[e].w, this.separators[e].y + this.separators[e].h), t.lineWidth = this.strokeWeight, t.strokeStyle = "#FA576C", t.lineCap = "round", t.stroke();
  t.restore()
};
...
IOWA.CountdownTimer.Core.prototype.getPath = function (t) {
  for (var e = 66, i = this.element[t], n = i.getTotalLength(), r = this.quality, s = [], o = 0; r > o; o++) {
    var a = o * n / r,
